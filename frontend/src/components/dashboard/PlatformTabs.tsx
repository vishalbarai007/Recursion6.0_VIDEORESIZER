								...
								<div className="grid gap-2">
									<div className="flex items-center justify-between">
										...
										<select
											...
											defaultValue={
												settings.customSettings.filter
											}
										>
											<option value="normal">
												Normal
								...
								<div className="grid gap-2">
									<div className="flex items-center space-x-2">
										<Switch
											id="add-music"
											checked={
												settings.customSettings.addMusic
											}
										/>
									...
									<div className="flex items-center justify-between">
										...
										<select
											...
											className="rounded-md border border-gray-300 px-3 py-1 text-sm"
											defaultValue={
												settings.customSettings.effects
											}
										>
